...
DOT="$ROOT/examples/graphs/one_loop_15_external.dot"
OUT="${HYBRID3D_15EXT_RUNTIME_DIR:-$ROOT/tmp/one_loop_15_external_runtime_compare}"
...
section "One-loop 15-external LTD/CFF Symbolica runtime comparison"
